...
A package for monetary valuation of standing trees in Germany, including estimations of assortments, wood revenues and harvest
costs dependent on tree species, tree diameter, wood quality and harvest
...
forests, productive ecosystem services are of importance. Forest owners, especially
private forest owners, will be interested in the monetary return generated by
wood production. Net revenues for wood depend,  among others, on tree species, 
diameter, and wood quality. Also disturbance events affect the returns as wood
quality is reduced due to mechanical damage and and also the price is reduced due
to market effects (OUR PAPER, weiß nicht genau, wei das zitieren funktioniert).
...
<strong>woodValuationDE</strong> represent average conditions. Thus,
the estimations usually represent a strong simplification, since the variability
of these values is very large in practice. Estimations by
<strong>woodValuationDE</strong> will likely differ from
the actual conditions in forest stands. Furthermore, the assortment tables
