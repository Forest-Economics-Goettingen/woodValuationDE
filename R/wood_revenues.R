...
#' Wood revenues per unit volume
#'
#' The function estimates wood revenues per unit volume based on the assortment
#' tables of Offer and Staupendahl (2018) and the wood revenue function of von
#' Bodelschwingh (2018). Consequences of calamities are implemented based on
#' Dieter (2001), Fuchs et al. (under review) and Fuchs et al. (in preparation).
#' Apart from Dieter (2001), all functions and factors are based on data of
...
#'                          \code{\link{get_species_codes}}.
#' @return A vector with wood revenues per unit volume
